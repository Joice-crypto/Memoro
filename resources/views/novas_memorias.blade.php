...
@section('abas')
    <div class=" bg-light col">
        <form action="{{ route('memoria.create') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-3">
                <select name="alimento_id" class="form-select form-select-sm mb-3" aria-label="Large select example">
            ...
            <div id="camposAvaliacao" style="display: none;">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="avaliacaoAparencia" class="form-control" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
