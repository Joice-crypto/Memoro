    ...
    <div class="row h-100">
      <div class="col-2 bg-light">
        ...
        <div class="d-flex justify-content-center ">
            <img style="width:50px" class="my-3 "
            src="{{ asset('assets/icons8-usuário-homem-com-círculo-50.png') }}" alt="user">
        </div>
      ...
      <div class="col-9">
        ...
        <div class="tab-content" id="v-pills-tabContent">
            ...
            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">@yield('inventario')</div>
            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab"> @yield('entradas')</div>
            <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">Clicou aqui 4</div>
        </div>
